...
def generate_rois(components):
    ...
    for comp in p3_pool:
        ...
        for idx, item in enumerate(tagged_boxes):
            ...
            # Condition 1: Centroid dist < 120px and combined span <= 200px -> Merge
            ...
            # Condition 2: Centroid dist 120px-180px and combined span <= 200px -> Shift & Merge
...
# =====================================================================
# STAGE 3: CROP & NORMALIZE ENGINE (NATIVE 1:1 SCALE 256x256 RGB)
# =====================================================================
...
if __name__ == "__main__":
    ...
    for img_path in image_paths:
        ...
        print(f"[FAIL] {filename} -> Flagged Components: {len(components)} | Generated 256x256 ROIs: {num_rois_saved}")
