# reduced edge noise massively. BEST ONE YET. has some false positives due to minor noise. 

import cv2
import numpy as np

# 1. Load image in grayscale
# IMAGE_PATH = 'asset/cuts/c3.png'
IMAGE_PATH = 'asset/oil/o2.png'
# IMAGE_PATH = 'asset/normal/n6.png'
...
# Pad calibration patch using BORDER_REFLECT_101 to mirror full-image filtering conditions
...
# Crop back to central unpadded dimensions to measure baseline statistics
...
# Pad raw image by half the Gaussian kernel size (251 // 2 = 125) to prevent border sags
blur_pad = 125
...
# =====================================================================
# Double pad size to move BORDER_REFLECT_101 phase discontinuities outside Gabor Gaussian tails
pad_size = ksize
...
# =====================================================================
# Smooth 1D column profiles to remove spatial energy roll-off (vignetting)
...
# Column-normalized Z-scores using calibration patch variance as sensitivity baseline
...
cv2.imwrite('diag_01.5a_struct_raw.png', struct_mask.astype(np.uint8) * 255)
cv2.imwrite('diag_01.5b_intensity_raw.png', intensity_mask.astype(np.uint8) * 255)
